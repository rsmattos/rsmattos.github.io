...
- **Quantum Dynamics from Classical Trajectories (2024)** - *Journal of Chemical Theory and Computation*.   
  **Rafael S. Mattos**; Saikat Mukherjee; Mario Barbatti.  
  DOI:[10.1021/acs.jctc.4c00783](https://doi.org/10.1021/acs.jctc.4c00783) · [Journal](https://pubs.acs.org/doi/10.1021/acs.jctc.4c00783) · [Code](https://gitlab.com/rafaelcpii93/qdct)
...
- **Molecular Dynamics of the Ultrafast Excited-State Proton Transfer of the Super-Photoacid NM7HQ+ to the Aprotic Solvent DMSO (2025)** - *The Journal of Physical Chemistry Letters*.  
  ...
  DOI: [10.1021/acs.jpclett.5c02202](https://doi.org/10.1021/acs.jpclett.5c02202) · [Journal](https://pubs.acs.org/doi/10.1021/acs.jpclett.5c02202) · [ChemRxiv](https://chemrxiv.org/engage/chemrxiv/article-details/68776191fc5f0acb52773ac8)

- **ULaMDyn: enhancing excited-state dynamics analysis through streamlined unsupervised learning (2025)** - *Digital Discovery*.  
  ...
  DOI: [10.1039/D4DD00374H](https://doi.org/10.1039/d4dd00374h) · [Journal](https://pubs.rsc.org/en/content/articlelanding/2025/dd/d4dd00374h)
...
- **Gravitationally-induced wave function collapse time for molecules (2024)** - *Physical Chemistry Chemical Physics*.  
  Anderson A. Tomaz; **Rafael S. Mattos**; Mario Barbatti.  
  DOI: [10.1039/D4CP02364A](https://doi.org/10.1039/d4cp02364a) · [Journal](https://pubs.rsc.org/en/content/articlelanding/2024/cp/d4cp02364a)

- **Quantum Dynamics from Classical Trajectories (2024)** - *Journal of Chemical Theory and Computation*.  
  **Rafael S. Mattos**; Saikat Mukherjee; Mario Barbatti.  
  DOI:[10.1021/acs.jctc.4c00783](https://doi.org/10.1021/acs.jctc.4c00783) · [Journal](https://pubs.acs.org/doi/10.1021/acs.jctc.4c00783) · [Code](https://gitlab.com/rafaelcpii93/qdct)

- **Prediction Challenge: Simulating Rydberg photoexcited cyclobutanone with surface hopping dynamics based on different electronic structure methods (2024)** - *The Journal of Chemical Physics*.  
  Saikat Mukherjee; **Rafael S. Mattos**; Josene M. Toldo; Hans Lischka; Mario Barbatti.  
  DOI: [10.1063/5.0203636](https://doi.org/10.1063/5.0203636) · [Journal](https://pubs.aip.org/aip/jcp/article-abstract/160/15/154306/3282874/Prediction-Challenge-Simulating-Rydberg?redirectedFrom=fulltext) · [Hal](https://hal.science/hal-04548371v1)

- **Recommendations for Velocity Adjustment in Surface Hopping (2024)** - *Journal of Chemical Theory and Computation*.  
  Josene M. Toldo; **Rafael S. Mattos**; Max Pinheiro, Jr.; Saikat Mukherjee; Mario Barbatti.  
  DOI: [10.1021/acs.jctc.3c01159](https://doi.org/10.1021/acs.jctc.3c01159) · [Journal](https://pubs.acs.org/doi/10.1021/acs.jctc.3c01159)

- **On the Cooperative Origin of Solvent-Enhanced Symmetry-Breaking Charge Transfer in a Covalently Bound Tetracene Dimer Leading to Singlet Fission (2022)** - *Journal of the American Chemical Society*.  
  **Rafael S. Mattos**; Irene Burghardt; Adelia J. A. Aquino; Thiago M. Cardozo; Hans Lischka.  
  DOI: [10.1021/jacs.2c10129](https://doi.org/10.1021/jacs.2c10129) · [Journal](https://pubs.acs.org/doi/10.1021/jacs.2c10129)

- **Encapsulation of Aromatic Guests in the Bisporphyrin Cavity of a Double-Stranded Spiroborate Helicate: Thermodynamic and Kinetic Studies and the Encapsulation Mechanism (2021)** - *The Journal of Organic Chemistry*.  
  Naoki Ousaka, Shinya Yamamoto, Hiroki Iida, Takuya Iwata, Shingo Ito, **Rafael Souza**, Yuh Hijikata, Stephan Irle, Eiji Yashima.  
  DOI: [10.1021/acs.joc.1c01155](https://doi.org/10.1021/acs.joc.1c01155) · [Journal](https://pubs.acs.org/doi/10.1021/acs.joc.1c01155)

### Thesis

- **Frozen Gaussian Wavepacket to Perform and Correct Nonadiabatic Mixed Quantum- Classical Dynamics (2024)**.  
  **Author**: Rafael Souza Mattos · **Supervisor**: Mario Barbatti · [PDF](https://zenodo.org/records/14656144)
